...
<body>
    ...
    <center> <h1 style="margin-bottom: 30px; font-family: 'Overpass', sans-serif; color: #6495ED;"><b>Add New User</b></h1></center>
						...
						<div class="form-row">
						 ...
						 <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="password" name="password" class="form-control" id="password" placeholder="Password" required><span><i class="fa fa-eye" id="eye"></i></span>
                            </div>
                        </div>
                        <div class="form-group">

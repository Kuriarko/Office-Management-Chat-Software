...
<div class="messaging">
      <div class="inbox_msg">
           ...
           <?php
            ...
            <div class="chat_list" <?php if($bb->phone==$r2->phone){ ?>
              ...
              <div class="chat_people">
                <div class="chat_img">  <a href="<?php echo base_url();?>Mycontroller/dochat1/<?php echo $r2->phone;?>"><img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"></a> </div>
                <div class="chat_ib">
                 <a href="<?php echo base_url();?>Mycontroller/dochat1/<?php echo $r2->phone;?>"><h5><?php echo $r2->name;?> </h5></a>
		...
		<form action="<?php echo base_url();?>Mycontroller/dochat" method="post" enctype="multipart/form-data">
		<input type="hidden" value="<?php echo $bb->phone; ?>" name="cat_id">
        <div class="mesgs">

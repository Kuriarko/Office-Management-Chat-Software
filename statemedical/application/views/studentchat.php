   ...
   <section id="main-content">
      <section class="wrapper">
    		<div class="container">
		      ...
		      <form action="<?= base_url(); ?>index.php/Mycontroller/studentdochat" method="post">          
            <div class="col-sm-12">
                <div class="chatbody" style="width: 700px; height: 300px;">

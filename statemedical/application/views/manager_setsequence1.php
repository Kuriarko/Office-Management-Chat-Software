...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <center> <h1 style="margin-bottom: 30px; font-family: 'Overpass', sans-serif; color: #6495ED;"><b>Set New Despatch Sequence</b></h1></center>
					
                    <form action="<?php echo base_url();?>index.php/Mycontroller/manager_setsequencedo1" method="post">
                        <div class="form-row">

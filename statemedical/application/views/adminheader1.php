    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h1>
                    <a href="index.html" style="font-size: 25px;">State Medical Faculty Of West Bengal</a>
                </h1>
                ...
                <li>
				  ...
				  <li>
                    ...
                    <ul class="collapse list-unstyled" id="Submenu">
                        <li>
                            <a href="<?php echo base_url();?>Mycontroller/newdiary">Generate New Diary</a>
                        </li>
                        <li>
                            <a href="carousels.html">View Diary Status</a>
                        </li>
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    ...
                                    <div class="profile-r align-self-center">
                                        <h3 class="sub-title-w3-agileits"><?php echo $records1->name;?></h3>
                                        <a href="mailto:info@example.com"><?php echo $records1->email;?></a>
                                    </div>
                                </div>
                                <a href="#" class="dropdown-item mt-3">
                                    <h4>

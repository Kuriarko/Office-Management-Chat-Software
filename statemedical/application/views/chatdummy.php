           ...
           <?php
            ...
            <div class="chat_list">
              <div class="chat_people">
                <div class="chat_img">  <a href="<?php echo base_url();?>index.php/Mycontroller/dochat1/<?php echo $r2->phone;?>"><img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"></a> </div>
                <div class="chat_ib">
                 <a href="<?php echo base_url();?>index.php/Mycontroller/dochat1/<?php echo $r2->phone;?>"><h5><?php echo $r2->name;?> </h5></a>

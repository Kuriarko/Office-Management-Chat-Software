 ...
 <body>
        ...
        <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
					    ...
					    <center> <h1 style="margin-bottom: 30px; font-family: 'Overpass', sans-serif; color: #6495ED;"><b>Assigned Diaries</b></h1></center>
...
$(document).ready(function() {
    $('#book-table').DataTable({
        ...
        "ajax": {
            'url':'<?=base_url()?>index.php/Mycontroller/userdiaries_page/<?php echo $records->phone;?>'
        ...
        'columns': [
            ...
            $(nTd).html("<a href='<?php echo base_url();?>index.php/Mycontroller/managerclickeddiaries/"+oData.diary_no+"'>"+oData.diary_no+"</a>");
			 $(nTd).css("color", "blue");
        }

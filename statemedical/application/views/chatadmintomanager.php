...
<div class="messaging">
      <div class="inbox_msg">
           ...
           <?php
            ...
            <div class="chat_list" <?php if($bb->email==$r2->email){ ?>
              ...
              <div class="chat_people">
                <div class="chat_img">  <a href="<?php echo base_url();?>Mycontroller/dochatadmintomgr/<?php echo $r2->email;?>"><img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"></a> </div>
                <div class="chat_ib">
                 <a href="<?php echo base_url();?>Mycontroller/dochatadmintomgr/<?php echo $r2->email;?>"><h5><?php echo $r2->name;?> </h5></a>
		...
		<form action="<?php echo base_url();?>Mycontroller/dochatpermanent" method="post" enctype="multipart/form-data">
		<input type="hidden" value="<?php echo $bb->email; ?>" name="cat_id">
        <div class="mesgs">

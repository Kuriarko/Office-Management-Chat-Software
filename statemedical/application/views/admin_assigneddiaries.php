...
<div class="card-columns">
       ...
       <div class="card">
                        ...
                        <div class="card-body">
							...
							if($status == "Open")
							{ ?>
					         <a href="<?php echo base_url();?>Mycontroller/admin_startworking/<?php echo $r->id;?>" class="btn more mt-3" >Start Working</a>
							 <a href="<?php echo base_url();?>Mycontroller/admin_forwarddiary/<?php echo $r->id;?>" class="btn more mt-3" >Forward to Users</a>
							 <a href="<?php echo base_url();?>Mycontroller/admin_forwarddiary1/<?php echo $r->id;?>" class="btn more mt-3" >Forward to IT-Division,SMFWB</a>
							...
							<a href="<?php echo base_url();?>Mycontroller/admin_startworking/<?php echo $r->id;?>" class="btn more mt-3" >Ongoing Work</a>
					         <a href="<?php echo base_url();?>Mycontroller/admin_forwarddiary/<?php echo $r->id;?>" class="btn more mt-3" >Forward to Users</a>
							 <a href="<?php echo base_url();?>Mycontroller/admin_forwarddiary1/<?php echo $r->id;?>" class="btn more mt-3" >Forward to IT-Division,SMFWB</a>

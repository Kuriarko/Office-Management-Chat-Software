                  ...
                  ?>
                        <tbody>
                            <tr>
								...
								<td>
								<button type="button" class="btn btn-primary"><a href="<?php echo base_url();?>Mycontroller/userupdate/<?php echo $r->uid;?>">Update</a></button>
								<button type="button" class="btn btn-danger"><a onclick="return checkdelete()" href="<?php echo base_url();?>Mycontroller/userdelete/<?php echo $r->uid;?>">Delete</a></button>

...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<body>	 
	   ...
	   <center> <h1 style="margin-bottom: 30px; font-family: 'Overpass', sans-serif; color: #6495ED;"><b>Add New Diary</b></h1></center>
                    ...
                    <form action="<?php echo base_url();?>index.php/Mycontroller/manager_adddiarydo" method="post" enctype="multipart/form-data">
                        <div class="form-row">
			 ...
			 <input type="text" name="whom" class="form-control" id="whom" value="<?php echo $records->name;?>" required readonly>
						 ...
						 <div class="form-group col-md-4">
                                ...
                                <input type="text" name="from_whom" class="form-control" id="inputEmail4" value="<?php echo $this->session->userdata('name');?>" required readonly>
                            </div>
						...
						<div class="form-row">
                            ...
                            <label for="inputAddress">Diary_Type</label>
				   <input type="text" name="diary_type" class="form-control" id="inputPassword4" value="<?php echo $records1->type;?>" required readonly>
						...
						<div class="form-row">
						 <div class="form-group col-md-6">
							...
							<?php if($records1->type == "Receiving"){ ?>
                            <input type="text" name="diary_no" class="form-control" id="diary_no" value="<?php 
						...
						<div class="form-group col-md-6">
						 ...
						 <input type="text" name="file_no" class="form-control" id="file_no" value="">
...
var diary_no = $('#diary_no').val();
  ...
  if(diary_no!="")
  {
    jQuery.ajax({
    type: "POST",
    url: "<?php echo base_url('/index.php/Mycontroller/checkDiaryNo'); ?>",
    dataType: 'html',
    ...
    success: function(res) 
    {
      ...
      $('#diary_no').val('');  
      $("#msg1").css({"color":"red"});
      $("#msg1").html("This Diary No. already exists").fadeIn().delay(3000).fadeOut('slow');
           
      }
      else
      {
      $("#msg1").css({"color":"green"});
      $("#msg1").html("Congrates Diary No. available !").fadeIn().delay(3000).fadeOut('slow'); 
      }

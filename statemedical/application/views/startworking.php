            <div class="container-fluid">
                <div class="row">
					...
					<center><h3 style="margin-top: 30px;"><?php echo $records->diary_no;?></h3></center>
                        <div class="stat-grid p-3 d-flex align-items-center justify-content-between bg-primary" style="margin-top: 50px;">
                            <div class="s-l">
                               <a href="<?php echo base_url();?>index.php/Mycontroller/viewdiarydocs/<?php echo $records->diary_no;?>"><h5>Documents Of The Project</h5></a>
                            </div>
						 ...
						 <div class="stat-grid p-3 d-flex align-items-center justify-content-between bg-success" style="margin-top: 50px;">
                            <div class="s-l">
                               <a href="<?php echo base_url();?>index.php/Mycontroller/writecomment/<?php echo $records->diary_no;?>"><h5>Comments</h5></a>
                            </div>
						 ...
						 <div class="stat-grid p-3 d-flex align-items-center justify-content-between bg-warning" style="margin-top: 50px;">
                            <div class="s-l">
                                <a href="<?php echo base_url();?>index.php/Mycontroller/uploaddocs/<?php echo $records->diary_no;?>"><h5>Upload New Document</h5></a>
                            </div>
                            ...
                            <div class="s-l">
                                <a href="<?php echo base_url();?>index.php/Mycontroller/editfileno/<?php echo $records->diary_no;?>"><h5>Add/Edit File_No.</h5></a>
                            </div>
				...
				<center><a href="<?php echo base_url();?>index.php/Mycontroller/submitwork/<?php echo $records->id;?>"><button class="btn btn-style"  style="margin-top: 50px;">Submit Task</button></a></center>
            </div>

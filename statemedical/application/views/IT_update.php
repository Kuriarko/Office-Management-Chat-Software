...
<body>
    ...
    <center> <h1 style="margin-bottom: 30px; font-family: 'Overpass', sans-serif; color: #6495ED;"><b>Update User</b></h1></center>
                    ...
                    <form action="<?php echo base_url();?>Mycontroller/ITupdatedo" method="post">
                        <?php foreach($records as $r){ ?>
						<div class="form-group">
                            
                            <input type="hidden" name="aid" class="form-control" id="inputAddress" value="<?php echo $r->aid;?>" required readonly>
                        </div>
						<div class="form-row">

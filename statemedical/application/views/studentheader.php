            ...
            <ul class="list-unstyled components">
                ...
                <li style="margin-bottom: 20px;">
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu" >
					 <li>
                            <a href="<?php echo base_url();?>Mycontroller/studentadddiary">Generate Diary To Users</a>
                        </li>
						
						 <li>
                            <a href="<?php echo base_url();?>Mycontroller/adminmanager_adddiary">Generate Diary To IT Division</a>
                        </li>
                       

                        <li>
                            <a href="<?php echo base_url();?>Mycontroller/assigneddiariestables">My Assigned Diaries Tables</a>
                        </li>
						
						 <li>
                            <a href="<?php echo base_url();?>Mycontroller/diaryhistory">History</a>
                        </li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu1">
					 <li>
                            <a href="<?php echo base_url();?>Mycontroller/chatbegin1">Chat With Secretary,SMFWB</a>
                        </li>
						
						<li>
                            <a href="<?php echo base_url();?>Mycontroller/studentchat2">Chat With IT Division</a>
                        </li>
                       

                        <li>
                            <a href="<?php echo base_url();?>Mycontroller/studentchat">Chat with other users</a>
                        </li>
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
						...
						<a href="<?php echo base_url();?>Mycontroller/user_home"><button type="button" class="btn btn-info navbar-btn">
					...
					<!---notification from admin-manager---->
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    ...
                                    <div class="profile-r align-self-center">
                                        ...
                                        <a href="#"><?php echo $records->phone;?></a>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item" href="<?php echo base_url();?>index.php/Mycontroller/studentlogout">Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
...
$("#show").hover(function() {
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('index.php/Mycontroller/show_customers'); ?>",
...
$("#show1").hover(function() {
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('index.php/Mycontroller/show_usermessages'); ?>",
        success: function(data) {
...
$("#show2").hover(function() {
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('index.php/Mycontroller/show_mgrmessages'); ?>",
        success: function(data) {
